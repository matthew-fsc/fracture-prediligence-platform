"""
Seed script — ABC Company Inc
Wipes company_id=1 and populates with real financial data:
...
from app.ontology.models import (
    Company, RevenueStream, Customer, Employee, Expense, Contract,
    RevenueType, ExpenseCategory, EmployeeStatus, ConfidenceLevel,
)
