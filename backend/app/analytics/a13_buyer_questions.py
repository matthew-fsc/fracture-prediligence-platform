...
_LIBRARY: dict[str, list[tuple]] = {
    ...
    "financial_integrity": [
        (95, "HIGH", "PE",
         "Revenue declined from 2023 to 2024 before recovering in 2025 — can you explain the net loss year in 2024 and what changed operationally?",
         "2024 P&L detail, explanation of revenue decline drivers, corrective actions taken"),
        (95, "HIGH", "All",
         "What is the basis for the officers' salary addback in your EBITDA recast — what is the documented market rate for a replacement operations director in this role?",
         "Officers' salary documentation, market comp benchmarks for equivalent field services operations role, addback methodology"),
        (50, "CRITICAL", "All",
    ...
    "customer_risk": [
        (80, "CRITICAL", "All",
         "What happens to your revenue if COMPANY 1 does not renew — they represent the single largest customer relationship?",
         "COMPANY 1 contract, renewal history, relationship ownership, notice period"),
        (80, "CRITICAL", "All",
         "Your top 2 customers represent approximately 68% of revenue. What is your strategy to mitigate this concentration risk before a transaction?",
         "Customer diversification plan, pipeline of new customer prospects, timeline to reduce concentration below 40%"),
        (80, "CRITICAL", "All",
         "What contracts govern your customer relationships — are they purchase orders, master service agreements, or verbal commitments?",
         "Full contract register with type, term, value, and renewal provisions for all active customers"),
        (50, "CRITICAL", "All",
