        ...
        {tab === 'account' && (
          <div style={{ background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: 12, padding: 16 }}>
            <UserProfile
              ...
              appearance={{
                variables: {
                  colorPrimary: COLORS.gold, colorBackground: COLORS.card,
                  colorText: COLORS.offWhite, colorTextSecondary: COLORS.muted,
                  colorInputBackground: COLORS.bg, colorInputText: COLORS.offWhite, borderRadius: '8px',
                },
                elements: {
